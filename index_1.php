...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>Digitech - Technology IT Solutions </title>
                ...
                <div class="container">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        ...
                                        <div class="service-item">
                                            ...
                                            <div class="service-content">
                                                <h3 class="title"><a href="#">Data Centers</a></h3>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="service-item">
                                            ...
                                            <div class="service-content">
                                                <h3 class="title"><a href="#">Server and Desktop Virtualization</a></h3>
                                                <a class="read-more" href="#"><i class="fas fa-long-arrow-alt-right"></i></a>
                                            </div>
                                        </div>
                                        <!-- Service Item End -->
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="service-item">
                                            ...
                                            <div class="service-content">
                                                <h3 class="title"><a href="#">Enterprise Resource Planning Systems</a></h3>
                                                <a class="read-more" href="#"><i class="fas fa-long-arrow-alt-right"></i></a>
                                            </div>
                                        </div>
                                        <!-- Service Item End -->
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="service-item">
                                            ...
                                            <div class="service-content">
                                                <h3 class="title"><a href="#">Corporate Networks and Switching</a></h3>
                                                <a class="read-more" href="#"><i class="fas fa-long-arrow-alt-right"></i></a>
                                            </div>
                                        </div>
                                        <!-- Service Item End -->
                    ...
                    <div class="row jusify-content-center">
                        <div class="case-study-btn text-center mt-35">
                            <a class="btn" href="service.php">See More Services</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="features-content-wrap">
                                ...
                                <div class="features-content">
                                    ...
                                    <div class="features-link">
                                        <p>This is only glimpse see <a href="service.php">All Features</a></p>
                                    </div>
                                </div>
...
<!--
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="features-img-wrap">
                                    <div class="features-img image-1">
                                        <img src="assets/images/features-img-2.jpg" alt="">
                                    </div>
                                    <div class="features-img image-2">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="features-content">
                                    <div class="section-title">
                                        <h2 class="title">We run all kinds of <span>IT services</span> that vow your success</h2>
                                    </div>
                                    <p>Accelerate innovation with world-class tech teams We’ll match you to an entire remote team of incredible freelance talent for all your software development needs.</p>
                                     Features Item Wrap Start 
                                    <div class="features-item-wrap">
                                        <div class="col">
                                             Features Item Start 
                                            <div class="features-item text-center">
                                                <img src="assets/images/features-1.png" alt="">
                                                <h3 class="title">Professional <br> IT Team</h3>
                                            </div>
                                             Features Item End 
                                        </div>
                                        <div class="col">
                                            ...
                                            <div class="features-item text-center">
                                                <img src="assets/images/features-2.png" alt="">
                                                <h3 class="title">Quality check <br> Expert</h3>
                                            </div>
                                             Features Item End 
                                        </div>
                                        <div class="col">
                                            ...
                                            <div class="features-item text-center">
                                                <img src="assets/images/features-4.png" alt="">
                                                <h3 class="title">24/7 dedicated <br>Support</h3>
                                            </div>
                                             Features Item End 
                                        </div>
                                    </div>
                                     Features Item Wrap End 
                                </div>
                                 Features Content End 
                            </div>
                        </div>
            ...
            <!-- Case Study Start -->
            <div class="section case-study-section section-padding pt-70 pb-70">
                <div class="container">
                ...
                <div class="row jusify-content-center">
                    <div class="case-study-btn text-center">
                        <a class="btn" href="service.php">See More Projects</a>
                    </div>
                </div>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header header-one" id="headingOne">
                                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        <span class="number">01</span> How Long it takes finished projects?
                                                        <span class="faq-button"><i class="fas fa-chevron-right"></i></span>
                                                    </button>
                                                </h2>
                                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>Accelerate innovation with world-class tech teams We’ll match you to an entire remote team of incredible freelance talent for all your software.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingTwo">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                        <span class="number">02</span> Support & Policy
                                                        <span class="faq-button"><i class="fas fa-chevron-right"></i></span>
                                                    </button>
                                                </h2>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingThree">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                        <span class="number">03</span> Refund Solution
                                                        <span class="faq-button"><i class="fas fa-chevron-right"></i></span>
                                                    </button>
                                                </h2>
